//mpicc -g -Wall -o linked_rwl linked_rwl.c my_rand.c -lpthread
#include <stdio.h>
#include <stdlib.h>
#include <pthread.h>
#include "my_rand.h"
...
void Get_input(int* inserts_in_main_p) {
   printf("Cuántas llaves deben insertarse en el hilo principal?\n");
   scanf("%d", inserts_in_main_p);
   printf("HCuántas operaciones en total se deben ejecutar?\n");
   scanf("%d", &total_ops);
   printf("Porcentaje de operaciones que deberían ser búsquedas? (0 o 1)\n");
   scanf("%lf", &search_percent);
   printf("Porcentaje de operaciones que deberían ser inserciones? (0 o 1)\n");
